...
<div :class="sidebarOpen ? 'w-64' : 'w-0'"
    class="transition-all duration-300 bg-base-200 dark:bg-base-100 flex-col hidden lg:flex justify-between">
    ...
    <div class="">
        ...
        <ul x-show="sidebarOpen" class="menu flex-1 px-2 w-full rounded-md dark:text-warning">
            ...
            <li class="rounded-lg mb-2 {{ request()->routeIs('absensi') ? 'bg-neutral-content dark:bg-neutral' : '' }}">
